...
func (g *GitlabProvider) AddCollaborator(user string, organisation string, repo string) error {
	fmt.Sprintf("Automatically adding the pipeline user as a collaborator is currently not implemented for gitlab. Please add user: %v as a collaborator to this project.", user)
	return nil
}
...
func (g *GitlabProvider) ListInvitations() ([]*github.RepositoryInvitation, *github.Response, error) {
	fmt.Sprintf("Automatically adding the pipeline user as a collaborator is currently not implemented for gitlab.")
