...
import (
	...
	"github.com/jiubian-cicd/env-controller/pkg/kube/naming"
	"github.com/jiubian-cicd/env-controller/pkg/log"
	"github.com/jiubian-cicd/env-controller/pkg/secreturl/fakevault"
...
func (o *StepHelmApplyOptions) Run() error {
	...
	//helmBinary, noTiller, helmTemplate := "helm", false, false
	//if err != nil {
	//	return err
	//}
	...
	if releaseName == "" {
		fmt.Println("dev ns is : %s", devNs)
		releaseName = "temp-release-name";
	}
	info := util.ColorInfo
